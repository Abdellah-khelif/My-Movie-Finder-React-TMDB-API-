...
const App = () => {
  ...
  const [debouncedSearchTerm, setdebouncedSearchTrem] = useState("");

  useDebounce(() => setdebouncedSearchTrem(searchTerm), 500, [searchTerm]);
  ...
  const fetchMovies = async (query = "") => {
    ...
    try {
      ...
      setErrorMessage("Error frtching movies. Pleas try again later.");
    } finally {
      setisLoading(false);
    }
  };
